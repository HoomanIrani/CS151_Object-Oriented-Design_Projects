...
public class Calculator extends JFrame {
    ...
    public Calculator() {
        ...
        operatorButtonPanel.add(multiSign);
        ...
        multiSign.addActionListener(opListener);
